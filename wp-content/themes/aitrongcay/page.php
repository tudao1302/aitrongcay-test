                                            ...
                                            <div class="market-row-text">
                                                ...
                                                <div class="market-card-actions-row single-line" style="margin-top:12px">
                                                    <div class="market-card-social single-line">
                                                        <a class="market-social-btn market-owner-pill" href="<?php echo esc_url(aitrongcay_market_zalo_action_url((int) get_the_ID())); ?>" data-open-market-zalo="<?php echo esc_attr((string) get_the_ID()); ?>" aria-label="Nhắn Zalo"><span class="market-social-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="16" height="16" fill="none"><rect x="3" y="3" width="18" height="18" rx="6" fill="#0068FF"></rect><path d="M7.5 8.2h9l-6.05 7.6h5.95l-9 0 6.05-7.6H7.5Z" fill="#fff"></path></svg></span><span>Zalo</span></a>
