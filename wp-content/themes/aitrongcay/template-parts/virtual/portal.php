...
<?php if ($slug === 'portal/nhat-ky-cham-soc') : ?>
    ...
    <div style="margin-bottom:24px;display:flex;align-items:center;gap:12px;flex-wrap:wrap">
        ...
        <label style="font-weight:600;font-size:14px;display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.05);padding:8px 16px;border-radius:14px;color:#fff">Rack: 
            <select id="nkRackSelect" onchange="AITR_NK_FILTER_RACK(this.value)" style="border:none;background:transparent;font-weight:700;font-size:15px;color:#6fdba8;outline:none;cursor:pointer">
        ...
        <label style="font-weight:600;font-size:14px;display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.05);padding:8px 16px;border-radius:14px;color:#fff">Khoang: 
            <select id="nkKhoangSelect" onchange="AITR_NK_FILTER_KHOANG(this.value)" style="border:none;background:transparent;font-weight:700;font-size:15px;color:#6fdba8;outline:none;cursor:pointer">
            </select>
        </label>
        
        <a href="#" id="nkViewTimelapseBtn" class="btn btn-primary" style="margin-left:auto;border-radius:14px;padding:8px 20px">Xem Timelapse</a>
    </div>
