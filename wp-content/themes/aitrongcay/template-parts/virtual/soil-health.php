...
<section class="d2-app">
  <style>
    ...
    .d2-top { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px; }
    ...
    @media (max-width: 1024px) {
      ...
      .d2-nav { grid-template-columns: repeat(6, 1fr); gap: 8px; padding: 0; }
      .d2-nav a { flex-direction: column; padding: 10px 8px; font-size: 11px; }
