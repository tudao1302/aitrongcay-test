...
<section class="section-tight" style="background:#121411;min-height:100vh;padding:0">
  <style>
    ...
    .eco-warehouse-avatar{width:42px;height:42px;border-radius:999px;border:2px solid var(--primary);display:grid;place-items:center;background:#1a1c19}
    ...
    @media (max-width:980px){.eco-warehouse-shell{padding-bottom:calc(104px + env(safe-area-inset-bottom,0px))}.eco-warehouse-topbar{grid-template-columns:1fr;justify-items:stretch;padding:14px 16px}.eco-warehouse-garden-name{font-size:28px}.eco-warehouse-top-links{justify-content:flex-start;overflow:auto;padding-bottom:4px}.eco-warehouse-search{min-width:0;width:100%}.eco-warehouse-top-right{justify-content:space-between}.eco-warehouse-layout{grid-template-columns:1fr;padding:16px 16px 14px}.eco-shared-side{position:fixed;left:12px;right:12px;bottom:calc(16px + env(safe-area-inset-bottom,0px));top:auto;z-index:65;padding:11px 12px calc(11px + env(safe-area-inset-bottom,0px));border-radius:26px;background:rgba(7,33,24,.88);backdrop-filter:blur(26px);-webkit-backdrop-filter:blur(26px);box-shadow:0 20px 44px rgba(0,0,0,.30),inset 0 1px 0 rgba(255,255,255,.06)}.eco-shared-side-head{display:none}.eco-shared-side nav{margin-top:0;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.eco-shared-side nav a{flex-direction:column;justify-content:center;text-align:center;padding:10px 8px;border-radius:18px;font-size:11px;line-height:1.15;gap:5px;font-weight:700;color:rgba(227,227,222,.74)}.eco-shared-side nav a.is-desktop-only,.eco-side-link-label{display:none}.eco-side-link-short{display:block}.eco-side-link-icon{font-size:20px}.eco-shared-side nav a.active{border-radius:18px;background:linear-gradient(180deg,rgba(111,219,168,.24),rgba(49,163,117,.92));color:#f7fff9;font-weight:800;box-shadow:inset 0 1px 0 rgba(255,255,255,.16),0 10px 22px rgba(49,163,117,.22)}.eco-warehouse-hero h1{font-size:44px}.eco-warehouse-hero p{font-size:10px;color:#6fdba8 !important}.eco-warehouse-slider{padding:0 54px}.eco-warehouse-slider::before,.eco-warehouse-slider::after{width:58px}.eco-warehouse-slider-track{gap:16px;padding-bottom:10px;scroll-padding-inline:calc(50% - 140px)}.eco-warehouse-slider-track > *{flex-basis:calc(100% - 8px);min-width:0}.eco-warehouse-slider-track > *.is-featured{transform:translateY(-4px) scale(1.01)}.eco-warehouse-card h3{min-height:54px}.eco-warehouse-meta{min-height:66px}.eco-warehouse-slider-nav{width:46px;height:46px;font-size:24px}.eco-warehouse-feature{grid-template-columns:1fr}.eco-warehouse-feature h2{font-size:40px}}
  </style>
  <div class="eco-warehouse-shell">
    ...
    <header class="eco-warehouse-topbar">
      ...
      <div class="eco-warehouse-top-right">
        ...
        <?php endif; ?>
        <div class="eco-warehouse-avatar" aria-hidden="true">🔔</div>
        <div class="eco-warehouse-avatar" aria-hidden="true">⚙️</div>
        <button class="eco-warehouse-avatar eco-warehouse-profile-trigger" type="button" data-eco-warehouse-profile-trigger aria-expanded="false">👤</button>
      </div>
